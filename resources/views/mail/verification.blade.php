                ...
                <table width="600px" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td style="padding: 30px; text-align: center;">
                            ...
                            <h3 style="color: #333;">Kode Verifikasi Anda</h3>
                            <p style="color: #666;">Gunakan kode berikut untuk memverifikasi email Anda:</p>

                            <p
                                style="font-size: 28px; font-weight: bold; color: #333; background: #f2f2f2; padding: 10px 20px; display: inline-block; border-radius: 5px;">
                                {{ $otp }}
                            </p>

                            <p style="color: #666;">Kode ini hanya berlaku selama <strong>10 menit</strong>.</p>

                            <p style="color: #666;">Jika Anda tidak meminta kode ini, abaikan email ini.</p>

                            <p><strong>PPDB SPENYOSI</strong></p>
                        </td>
                    </tr>
