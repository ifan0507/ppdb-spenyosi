                ...
                <table width="600px" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td style="padding: 30px; text-align: left;">
                            ...
                            <p style="color: #666;">Selamat! Data pendaftaran Anda telah berhasil diverifikasi dan
                                dinyatakan <strong>DITERIMA</strong> oleh panitia PPDB SMP Negeri 1 Yosowilangun.</p>

                            <p
                                style="font-size: 18px; font-weight: bold; color: #38c172; background: #f2f2f2; padding: 15px 20px; display: inline-block; border-radius: 5px;">
                                Silakan menunggu informasi lebih lanjut dari kami melalui WhatsApp atau email.
                            </p>

                            <p style="color: #666; margin-top: 20px;">Terima kasih telah melakukan pendaftaran.</p>
