                ...
                <div class="card card-primary card-outline card-outline-tabs col-md-12">
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data"
                            action="{{ route('afirmasi.update', ['id' => $data->id]) }}" id="main-form">
                            <input type="hidden" name="_token" value="" autocomplete="off">
                            <div class="row">
                                <div class="col-sm-8 col-lg-6">
                                    <div class="form-group required">
                                        <label class="title">Jenis Afirmasi</label>
                                        <select class="form-control" id="jenis_afirmasi" required=""
                                            name="jenis_afirmasi">
                                ...
                                <div class="col-sm-8 col-lg-4">
                                    <div class="border m-3 py-1 px-2 text-center" id="photo-box">
                                        ...
                                        <img id="img-prestasi_blob" src="{{ asset('storage/' . $data->afirmasi->image) }}"
